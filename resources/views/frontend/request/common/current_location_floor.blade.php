        ...
        <div class="modal" id="selectFloorModal" tabindex="-1" role="dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="min-height: 169px;">
                    ...
                    <div class="row">
                        <div class="col-12">
                                <button class ="btn south-btn btn-3 m-1 elevator-btn" id = "floor10">Use elevator</button>
                        </div>
                    </div>
                    <div class="row">
                    @for($i = 1; $i <= 9; $i++)
                        <div class="col-4">
                            <button class ="btn south-btn btn-3 m-1 floor-btn" id = "floor{{$i}}">{{$i}}floor</button>
                        </div>
                    @endfor
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#specialItemBtn').click(function () {
                ...
                //     url: '/put_session',
                //     type: 'POST',
                //     data: { "whereFrom":12,"floorFrom":15 },
