                        ...
                        <div class="card" style="margin: 10px 0">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item" style="font-size: 14px;"><img src="/frontend/assets/south/img/icons/garage.png" />
                                    Moving time
                                    <button type="submit" class="btn btn-link btn-sm watch" id="myTimeBtn" style="font-size: 14px;">Please select a time</button>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8" style="padding-right: 15px; padding-left: 15px;">
                    <div>
                        <p style="display: inline-block; font-size: 20px; margin-bottom: 0px; color:#ef6774; line-height: normal">378$</p>
